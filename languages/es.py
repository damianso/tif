...
'Configuran el sistema, determinando los empleos, estudios y determinando los usuarios del sistema y sus roles.': 'Configuran el sistema, determinando los empleos, estudios y determinando los usuarios del sistema y sus roles.',
...
'Deseas ingresar al sistema?': 'Deseas ingresar al sistema?',
'design': 'diseño',
'DESIGN': 'DISEÑO',
'Design': 'Design',
...
'Quiénes pueden ingresar aquí?': 'Quiénes pueden ingresar aquí?',
'RAM': 'RAM',
...
'shell': 'terminal',
'Si aún no sos usuario: ': 'Si aún no sos usuario: ',
'Si ya sos usuario: ': 'Si ya sos usuario: ',
'Sign Up': 'Sign Up',
'site': 'sitio',
'Size of cache:': 'Tamaño de la Caché:',
'some files could not be removed': 'algunos archivos no pudieron ser removidos',
'Son los encargados de ingresar los datos de los postulantes e imprimir los estudios que ellos deben realizarse según el empleo al que deseen postularse.': 'Son los encargados de ingresar los datos de los postulantes e imprimir los estudios que ellos deben realizarse según el empleo al que deseen postularse.',
'Son los encargados de realizar los reportes, para realizar un análisis de los datos del sistema.': 'Son los encargados de realizar los reportes, para realizar un análisis de los datos del sistema.',
'start': 'inicio',
